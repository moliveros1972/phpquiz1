...
$tags = ["Travel","Hello","Dinner","Salmon","France","Drinks","Ideas","Flavors","Cuisine","Chicken","Dressing","Fried","Fish","Duck"];
$food = [
	[
		"id" => "1",
		...
		<div class="w3-row-padding w3-padding-16 w3-center" id="#food">
            <?php foreach ($food as $f) { ?> 
                <div class="w3-quarter">
                    <img src="<?= $f["image"] ?>" alt="<?= $f["alt"]?>" style="width:100%">
                    <h3><?= $f["title"]?></h3>
                    <p><?= $f["desc"]?></p>
                </div>
            <?php } ?>
		...
		<footer class="w3-row-padding w3-padding-32">
			...
			<div class="w3-third w3-serif">
                ...
                <?php foreach ($tags as $item) { ?> 
                    <span class="w3-tag w3-black w3-margin-bottom"><?= $item ?></span>
                <?php } ?>
				</p>
			</div>
		</footer>
